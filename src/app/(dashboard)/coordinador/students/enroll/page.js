                 ...
                 <div className="grid gap-6">
                    <div className="space-y-2">
                      ...
                      <select 
                        ...
                        className="w-full bg-slate-50 border-none p-6 rounded-[28px] outline-none focus:ring-4 focus:ring-secondary-color/10 font-bold text-primary-color cursor-pointer appearance-none shadow-inner"
                      >
